...
public class BlueLeftCoralAuton extends SequentialCommandGroup {
  /** Creates a new RedRightCoralAuton. */
  public BlueLeftCoralAuton(DriveSubsystem _DriveSubsystem) {
    ...
    addCommands(
      ...
      new AutoAlignToReef(_DriveSubsystem, EReefAlignment.CENTER_REEF, 0.8, "back", 2),
      new AutoAlignToReef(_DriveSubsystem, EReefAlignment.CENTER_REEF, 3, "front", 2)
